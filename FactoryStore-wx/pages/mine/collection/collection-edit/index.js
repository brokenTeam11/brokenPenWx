// pages/mine/collection/collection-edit/index.js
const app = getApp()
Page({
  ...
  data: {
    ...
    limit:10,
    noneData: {
      src: '/static/images/img_collection@3x.png',
      info: '您还没有收藏的商品，快去逛一逛'
    },
    loading: false,
    noMore: false,
    move:false
